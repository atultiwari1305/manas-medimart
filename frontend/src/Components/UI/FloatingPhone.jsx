  ...
  return (
    ...
    <Image w={'80%'} src={logo} alt="MediMart Logo" style={{transform: "translatey(-200%)"}} />
      ...
      <motion.button
        ...
        style={{ color:'black', position: "absolute", bottom: "1rem", left: "1rem", right: "1rem", zIndex: "10", borderRadius: "0.5rem", border: "1px solid #FFFFFF", background: "#FFFFFF", padding: "0.5rem", fontSize: "0.875rem", fontWeight: "500", backdropFilter: "blur(20px)" }}
      >
        Join Now
      </motion.button>

      <div style={{ position: "absolute", bottom: "-12rem", left: "50%", height: "24rem", width: "24rem", transform: "translateX(-50%)", borderRadius: "50%", background: "#1a202c" }} />
    </div>
    </>
  );
};
